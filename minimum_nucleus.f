	...
	! all number densities and energy density are in MeV units

	 subroutine energy_density_minimum(Z, A, mu_e, mu_n, BE, kT, energy_density)
		real :: BE
	 ...
	 ! energy density from Roca-Maza (2008)
	 !
	 ...
	 !energy density of free neutrons
	 !
	 ...
	 end subroutine energy_density_minimum

	end module minimum_nucleus